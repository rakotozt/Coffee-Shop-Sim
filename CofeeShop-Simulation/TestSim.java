...
public class TestSim
{
    ...
    public  void fileReading(int cashiers){
        try { 
            ...
            // Reading the file 
            Scanner sc = null; 
            sc = new Scanner( new FileReader("inputTest.txt"));
    ...
    public void run(int cashiers){
       ...
       // System.out.println ("Num of cashiers: "+num_cashiers+" Netprofit: " + calc.calculateNetProfit(total_profit ,cost, num_cashiers) );
        ...
        // System.out.println ("Netprofit: " + calc.calculateNetProfit(total_profit ,cost, num_cashiers) ); 
        // System.out.println ("Average Wait-time: " + calc.avgWaitTime(waittime) );
        // System.out.println ("Max Wait-Time: " + calc.maxWaitTime(waittime)); 
        // System.out.printf("Over-Flow Rate In Percent: %.2f", calc.calculateOverFlow(num_cust_served,overflow)); 
